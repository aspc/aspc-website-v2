                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="flex items-center">
                          <StarRating rating={averageRatings.overallAverage} />
                          <span className="ml-2">
                      ...
                      <div>
                        ...
                        <div className="flex items-center">
                          <StarRating
                            rating={averageRatings.inclusivityAverage}
                          />
                          <span className="ml-2">
                      ...
                      <div>
                        ...
                        <div className="flex items-center">
                          <StarRating
                            rating={averageRatings.challengeAverage}
                          />
                          <span className="ml-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mb-2">
                      {review.challenge_rating !== undefined && (
                        <div className="text-sm flex items-center mb-2">
                          ...
                          <span className="inline">
                            <StarRating rating={review.challenge_rating || 0} />
                          </span>
                        </div>
                      )}
                      {review.inclusivity_rating && (
                        <div className="text-sm flex items-center mb-1">
                          ...
                          <span className="inline">
                            <StarRating
                              rating={review.inclusivity_rating || 0}
                            />
                          </span>
                        </div>
                      )}
