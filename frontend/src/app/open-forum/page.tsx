                ...
                {filteredEvents.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredEvents.map((event) => (
                            ...
                            >
                                <div
                                    className={`border-2 rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105 cursor-pointer h-full flex flex-col ${getEventStatusColor(event.eventDate)}`}
                                >
                                    {/* Event Header */}
